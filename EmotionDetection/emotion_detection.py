...
def emotion_detector(text_to_analyze):
    ...
    Returns:
        dict: A dictionary containing emotion scores and the dominant emotion.
              Returns None for all values if input is blank or status_code is 400.
    """
    ...
    # Access the status_code attribute for error handling
    # For status_code = 400, return None for all values
